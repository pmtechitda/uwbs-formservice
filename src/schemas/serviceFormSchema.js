...
const serviceFormSchemas = {
  ...
  createServiceFormSchema: {
    ...
    body: {
      type: "object",
      required: ["serviceType", "consumerNumber", "current_name", "current_mobileNumber"],
      properties: {
        serviceType: {
          type: "string",
        ...
        submittedBy: { type: "string", pattern: "^[0-9a-fA-F]{24}$" },
        submittedType: {
          type: "string",
      ...
      errorMessage: {
        ...
        properties: {
          ...
          assignedTo: "Invalid assignedTo (must be MongoDB ObjectId)",
          submittedBy: "Invalid submittedBy (must be MongoDB ObjectId)",
        },
      },
    },
    response: {
  ...
  getAllServiceFormsSchema: {
    ...
    querystring: {
      ...
      properties: {
        ...
        serviceType: { type: "string", enum: ["All", "MeterReplacement", "Mutation", "Reconnection", "Tanker"] },
        consumerNumber: { type: "string" },
